...
{
    public partial class StaffPlayerAccount_inSide : Form
    {
        ...
        public StaffPlayerAccount_inSide()
        {
            InitializeComponent();
        }
        ...
        private void RefreshPage()
        {
            ...
            if (PlayerDataBaseControl.isEnglish)
            {
                ...
                if (DataBaseControl.MatchingOneColumn_OfTable("GSDWarZone", "PlayerID", PlayerDataBaseControl.playerID))
                ...
                if (DataBaseControl.MatchingOneColumn_OfTable("GSDF1Race", "PlayerID", PlayerDataBaseControl.playerID))
            ...
            else
            {
                ...
                if (DataBaseControl.MatchingOneColumn_OfTable("GSEWarZone", "PlayerID", PlayerDataBaseControl.playerID))
        ...
        {
            Player.PlayerProfile_ChangeGoldCoins playerProfile_ChangeGoldCoins = new Player.PlayerProfile_ChangeGoldCoins();
            playerProfile_ChangeGoldCoins.ShowDialog();
            RefreshPage();
        }

        private void BtnViewPointCardHistory_Click(object sender, EventArgs e)
        {
            Player.PlayerProfile_ViewPointCardHistory playerProfile_ViewPointCardHistory = new Player.PlayerProfile_ViewPointCardHistory();
            playerProfile_ViewPointCardHistory.ShowDialog();
        }
