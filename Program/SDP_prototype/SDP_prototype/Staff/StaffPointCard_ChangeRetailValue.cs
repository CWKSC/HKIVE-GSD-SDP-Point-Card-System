...
{
    public partial class StaffPointCard_ChangeRetailValue : Form
    {
        public StaffPointCard_ChangeRetailValue()
        {
            InitializeComponent();
        }
        ...
        private void StaffPointCard_ChangeRetailValue_Load(object sender, EventArgs e)
        {
            txtRetailValue.Text = PointCardDataBaseControl.retailValue.ToString();
        }
