...
{
    public partial class PlayerProfile_ChangeProfile : Form
    {
        ...
        public PlayerProfile_ChangeProfile()
        {
            InitializeComponent();
        }
        ...
        {
            txtNewProfile.Text = PlayerDataBaseControl.playerProfile;
        }

        private void BtnChangeProfile_Click(object sender, EventArgs e)
        {
            PlayerDataBaseControl.Updata_PlayerProfile(txtNewProfile.Text);
            Close();
        }
