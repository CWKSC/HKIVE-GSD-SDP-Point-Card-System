...
{
    public partial class PlayerProfile_ChangeEmail : Form
    {
        ...
        public PlayerProfile_ChangeEmail()
        {
            InitializeComponent();
        }
        ...
        {
            PlayerDataBaseControl.Updata_PlayerEmail(txtNewEmail.Text);
            Close();
        }

        private void PlayerProfile_ChangeEmail_Load(object sender, EventArgs e)
        {
            txtNewEmail.Text = PlayerDataBaseControl.playerEmail;
        }
    }
}
