...
{
    public partial class CSMProfile_ChangeEmail : Form
    {
        ...
        {
            CSMDataBaseControl.Updata_CSMEmail(txtNewEmail.Text);
            Close();
        }

        private void PlayerProfile_ChangeEmail_Load(object sender, EventArgs e)
        {
            txtNewEmail.Text = CSMDataBaseControl.CSMEmail;
        }
    }
}
